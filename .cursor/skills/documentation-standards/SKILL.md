...
When translating existing content to English:

1. **Preserve meaning** - Don't lose context or nuance
2. **Use standard terminology** - Follow industry conventions
3. **Keep technical terms** - Some terms are universal (API, JSON, etc.)
4. **Maintain structure** - Keep same headings and organization
5. **Update examples** - Translate example text and comments
