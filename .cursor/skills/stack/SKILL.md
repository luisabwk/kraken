...
| Use Case | Technology |
|----------|------------|
| Production apps | PostgreSQL (e.g. Supabase) |
...
Configure the MCPs relevant to your project in the project's `AGENTS.md`. Common MCP categories:

| Category | Examples | When to Use |
|----------|----------|-------------|
| Documentation | context7 | Check package versions, API changes |
| Database | supabase, MongoDB | Manage tables, query data |
| Project Management | Linear, Jira/Atlassian, Notion | Track issues, documentation |
| Memory | Any memory MCP | Store/retrieve project context and learnings |
| Infrastructure | Railway, Vercel, AWS | Deploy and manage services |

### Using Documentation MCPs
